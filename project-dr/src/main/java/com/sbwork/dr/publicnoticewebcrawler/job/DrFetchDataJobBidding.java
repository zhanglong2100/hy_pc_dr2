...
@Slf4j
public class DrFetchDataJobBidding implements Job {


    private PublicNoticeBiddingService dataService = null;

    @Override
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        if (dataService == null) {
            dataService = SpringBeanUtil.getBean(PublicNoticeBiddingService.class);
        }
